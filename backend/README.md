...
## Project Structure
    ...
    ├── testapiautoteammemb_53667  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_53667`
...
2. Clone this repo and `cd testapiautoteammemb_53667`
